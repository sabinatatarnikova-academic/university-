...
public class OfflineClassMapperImpl implements OfflineClassMapper {
    ...
    public OfflineClassDTO toDto(OfflineClass offlineClass) {
        ...
        offlineClassDTO.teacher( teacherMapper.toDto( offlineClass.getTeacher() ) );
        offlineClassDTO.group( groupToGroupDTO( offlineClass.getGroup() ) );
    ...
    public OfflineClass toEntity(OfflineClassDTO offlineClassDTO) {
        ...
        offlineClass.teacher( teacherMapper.toEntity( offlineClassDTO.getTeacher() ) );
        offlineClass.group( groupDTOToGroup( offlineClassDTO.getGroup() ) );
